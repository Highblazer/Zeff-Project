...
Uses ctrader_open_api with new endpoint details
"""
...
# Override demo host with new credentials
EndPoints.PROTOBUF_DEMO_HOST = "demo-uk-eqx-01.p.c-trader.com"
TRADE_PORT = 5212  # SSL
QUOTE_PORT = 5211  # SSL
...
class TradeBot:
    ...
    def start(self):
        print(f"Connecting to cTrader FIX API: {EndPoints.PROTOBUF_DEMO_HOST}:{TRADE_PORT}")
        
        self.client = Client(EndPoints.PROTOBUF_DEMO_HOST, TRADE_PORT, TcpProtocol)
    ...
    def on_connected(self, client):
        print("Connected to cTrader FIX API!")
        self._authenticate()
